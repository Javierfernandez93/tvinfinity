...
class PayPal {
    ...
    const RETURN_URL = "https://www.moneytv.io/apps/paypal/";
    const CANCEL_URL = "https://www.moneytv.io/apps/backoffice";
    const URL = "https://www.moneytv.io/apps/admin/subcore/application/validate_buy.php";
