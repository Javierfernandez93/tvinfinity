...
class ReplyPerCatalogTagIntent extends Orm {
    ...
    public static function saveReplys(array $replys = null, int $catalog_tag_intent_chat_id = null) : bool {
        if(isset($replys) === true)
        {
            ...
            {
                $ReplyPerCatalogTagIntent = new ReplyPerCatalogTagIntent;
                $ReplyPerCatalogTagIntent->catalog_tag_intent_chat_id = $catalog_tag_intent_chat_id;
                $ReplyPerCatalogTagIntent->reply = $reply['value'];
                $ReplyPerCatalogTagIntent->create_date = time();

                return $ReplyPerCatalogTagIntent->save();
            }
