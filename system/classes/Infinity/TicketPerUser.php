...
use Infinity\ItemPerTicket;
use Infinity\UserSupport;
use Infinity\UserLogin;
...
class TicketPerUser extends Orm {
  ...
  public static function saveTicket(array $data = null) : bool|string
  {
