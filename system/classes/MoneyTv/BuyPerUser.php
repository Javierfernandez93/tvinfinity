...
use MoneyTv\CatalogCommission;
use MoneyTv\Product;
use MoneyTv\AdviceType;
use MoneyTv\LicencePerUser;
...
class BuyPerUser extends Orm {
  ...
  const URL_INSERT_INTO_ROCKET = 'https://www.qm.moneytv.site/app/application/insertIntoRocket.php';
