                    ...
                    <table class="table table-stripeds table-borderless align-items-center mb-0">
                        ...
                        <tbody>
                            <tr v-for="payment in payments">
                                ...
                                <td class="text-center">
                                    <p v-if="payment.ipn_data.observation" class="text-secondary mb-0">{{truncate(payment.ipn_data.observation)}}</p>
                                ...
                                <td class="align-middle text-center" v-if="payment.ipn_data">
                                    <div v-if="payment.status == STATUS.PENDING.code">
                                        <div v-if="payment.ipn_data.observation" class="mb-2"><button @click="viewObservation(payment.ipn_data.observation)" class="btn w-100 btn-sm px-3 btn-primary shadow-none mb-0">Ver Nota</button></div>
