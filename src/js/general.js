...
String.prototype.getFirstLetter = function () {
  return this != undefined ? this.charAt(0) : 'F'
}
...
{
    return `https://www.moneytv.io/${this}`
}
...
{
    return `${MAIN_PATH}app/application/get_qr_url.php?url=${this}`
}
...
String.prototype.isValidPhoneLength = function() 
{
...
String.prototype.getVimeoFrame = function()
{
...
String.prototype.secureUser = function()
{
