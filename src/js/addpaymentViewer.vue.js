                ...
                <div class="col-12 col-xl">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <label for="observation" class="text-xs">Agregar nota para el franquiciatario</label>
                            <div class="input-group mb-3">
                                <textarea v-model="buy.ipn_data.observation" id="observation" class="form-control p-3" aria-label="Nota"></textarea>
                            </div>
                        </div>
