            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body p-0">
                            <div class="chart">
                                <canvas id="chart-line-1" class="chart-canvas" height="100" width="296" style="display: block; box-sizing: border-box; height: 100px; width: 296.4px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 mt-sm-0 mt-4">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body p-0">
                            <div class="chart">
                                <canvas id="chart-line-2" class="chart-canvas" height="100" width="296" style="display: block; box-sizing: border-box; height: 100px; width: 296.4px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <td>
                                                        <div class="fc-scroller-harness">
                                                            <div class="fc-scroller" style="overflow: visible;">
                                                                <table class="fc-col-header " style="width: 905px;">
                                                                    <colgroup></colgroup>
                                                                    <tbody>
                                                                        <tr>
                                            ...
                                            <tbody>
                                                <tr class="fc-scrollgrid-section fc-scrollgrid-section-body ">
                                                    <td>
                                                        <div class="fc-scroller-harness">
                                                            <div class="fc-scroller" style="overflow: visible;">
                                                                <div class="fc-daygrid-body fc-daygrid-body-unbalanced fc-daygrid-body-natural" style="width: 905px;">
                                                                    <table class="fc-scrollgrid-sync-table" style="width: 905px;">
                                                                        <colgroup></colgroup>
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="fc-daygrid-day fc-day fc-day-mon fc-day-past" data-date="2020-12-07">
                                                                                    <div class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
                                                                                        ...
                                                                                        <div class="fc-daygrid-day-events" style="padding-bottom: 29.125px;">
                                                                                            <div class="fc-daygrid-event-harness fc-daygrid-event-harness-abs" style="right: -129.281px;"><a class="fc-daygrid-event fc-daygrid-block-event fc-h-event fc-event fc-event-draggable fc-event-resizable fc-event-start fc-event-end fc-event-past bg-gradient-warning">
                                                                                                    <div class="fc-event-main">
                                                                                                        <div class="fc-event-main-frame">
                                                                                                            <div class="fc-event-title-container">
