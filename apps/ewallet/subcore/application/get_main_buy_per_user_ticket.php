...
if($Token->checkToken(['token'=>$data['token'],'key'=>$data['key']]) || $UserLogin->logged === true)
{
	...
	if($UserLogin->logged === true)
	{
		...
		{
            $MainBuyPerUser = new Infinity\MainBuyPerUser;
...
function getPayPalForm($MainBuyPerUser = null,$main_buy_per_user = null,$company_id = null)
{
	...
	$redirectUrls->setReturnUrl("https://www.tvinfinityglobal.com/apps/paypal/index.php")
	    ->setCancelUrl("https://www.tvinfinityglobal.com/apps/paypal/index.php");
